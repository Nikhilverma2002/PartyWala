...
import com.example.partywala.Adapters.IntroViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (restorePrefData()) {
        ...
        mList.add(new intro_ScreenItem("PAYMENT", "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", R.drawable.ic_payment));
        mList.add(new intro_ScreenItem("DELIVERY", "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", R.drawable.ic_deliver_boy));
        // setup viewpager
